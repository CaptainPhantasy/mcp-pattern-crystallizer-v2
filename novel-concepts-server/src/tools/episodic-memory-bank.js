...
function generateAdaptation(baseEpisode, currentContext, query) {
    const modifications = [];
...
export const episodicMemoryBankDefinition = {
...
export async function handleEpisodicMemoryBank(args) {
    try {
